# -*- encoding: utf-8 -*-
# stub: arborist 0.2.0.pre20171122101643 ruby lib

Gem::Specification.new do |s|
  s.name = "arborist".freeze
  s.version = "0.2.0.pre20171122101643"
  ...
  s.files = [".document".freeze, ".simplecov".freeze, "ChangeLog".freeze, "Events.md".freeze, "History.md".freeze, "Manifest.txt".freeze, "Monitors.md".freeze, "Nodes.md".freeze, "Observers.md".freeze, "Protocol.md".freeze, "README.md".freeze, "Rakefile".freeze, "TODO.md".freeze, "Tutorial.md".freeze, "bin/arborist".freeze, "lib/arborist.rb".freeze, "lib/arborist/cli.rb".freeze, "lib/arborist/client.rb".freeze, "lib/arborist/command/ack.rb".freeze, "lib/arborist/command/client.rb".freeze, "lib/arborist/command/config.rb".freeze, "lib/arborist/command/start.rb".freeze, "lib/arborist/command/tree.rb".freeze, "lib/arborist/command/watch.rb".freeze, "lib/arborist/dependency.rb".freeze, "lib/arborist/event.rb".freeze, "lib/arborist/event/node.rb".freeze, "lib/arborist/event/node_acked.rb".freeze, "lib/arborist/event/node_delta.rb".freeze, "lib/arborist/event/node_disabled.rb".freeze, "lib/arborist/event/node_down.rb".freeze, "lib/arborist/event/node_quieted.rb".freeze, "lib/arborist/event/node_unknown.rb".freeze, "lib/arborist/event/node_up.rb".freeze, "lib/arborist/event/node_update.rb".freeze, "lib/arborist/event_api.rb".freeze, "lib/arborist/exceptions.rb".freeze, "lib/arborist/loader.rb".freeze, "lib/arborist/loader/file.rb".freeze, "lib/arborist/manager.rb".freeze, "lib/arborist/mixins.rb".freeze, "lib/arborist/monitor.rb".freeze, "lib/arborist/monitor/socket.rb".freeze, "lib/arborist/monitor_runner.rb".freeze, "lib/arborist/node.rb".freeze, "lib/arborist/node/ack.rb".freeze, "lib/arborist/node/host.rb".freeze, "lib/arborist/node/resource.rb".freeze, "lib/arborist/node/root.rb".freeze, "lib/arborist/node/service.rb".freeze, "lib/arborist/node_subscription.rb".freeze, "lib/arborist/observer.rb".freeze, "lib/arborist/observer/action.rb".freeze, "lib/arborist/observer/summarize.rb".freeze, "lib/arborist/observer_runner.rb".freeze, "lib/arborist/subscription.rb".freeze, "lib/arborist/tree_api.rb".freeze, "spec/arborist/client_spec.rb".freeze, "spec/arborist/dependency_spec.rb".freeze, "spec/arborist/event/node_delta_spec.rb".freeze, "spec/arborist/event/node_down_spec.rb".freeze, "spec/arborist/event/node_spec.rb".freeze, "spec/arborist/event/node_update_spec.rb".freeze, "spec/arborist/event_api_spec.rb".freeze, "spec/arborist/event_spec.rb".freeze, "spec/arborist/manager_spec.rb".freeze, "spec/arborist/mixins_spec.rb".freeze, "spec/arborist/monitor/socket_spec.rb".freeze, "spec/arborist/monitor_runner_spec.rb".freeze, "spec/arborist/monitor_spec.rb".freeze, "spec/arborist/node/ack_spec.rb".freeze, "spec/arborist/node/host_spec.rb".freeze, "spec/arborist/node/resource_spec.rb".freeze, "spec/arborist/node/root_spec.rb".freeze, "spec/arborist/node/service_spec.rb".freeze, "spec/arborist/node_spec.rb".freeze, "spec/arborist/observer/action_spec.rb".freeze, "spec/arborist/observer/summarize_spec.rb".freeze, "spec/arborist/observer_runner_spec.rb".freeze, "spec/arborist/observer_spec.rb".freeze, "spec/arborist/subscription_spec.rb".freeze, "spec/arborist/tree_api_spec.rb".freeze, "spec/arborist_spec.rb".freeze, "spec/data/monitors/pings.rb".freeze, "spec/data/monitors/port_checks.rb".freeze, "spec/data/monitors/system_resources.rb".freeze, "spec/data/monitors/web_services.rb".freeze, "spec/data/nodes/localhost.rb".freeze, "spec/data/nodes/sidonie.rb".freeze, "spec/data/nodes/sub/duir.rb".freeze, "spec/data/nodes/yevaud.rb".freeze, "spec/data/observers/auditor.rb".freeze, "spec/data/observers/webservices.rb".freeze, "spec/spec_helper.rb".freeze]
