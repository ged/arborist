...
class Arborist::Event
	...
	def match( object )
		return false unless object.respond_to?( :event_type )
		return true if object.event_type.nil?
		rval = object.event_type == self.type ||
			Regexp.new( object.event_type.gsub('.', '\\..') ).match( self.type )
